...
static const char *uart_filename = "/dev/ttyS1";
...
{	
   ...
   // SETUP UART    
   uart0_filestream = open(uart_filename, O_RDWR | O_NOCTTY | O_NDELAY);		//Open in non blocking read/write mode
 ...
 *                      after the function returns, value *length can be smaller than when
